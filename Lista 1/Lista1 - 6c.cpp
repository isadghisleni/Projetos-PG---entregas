...
// Compilando e buildando o programa de shader
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawArrays( GL_TRIANGLE_FAN, 3, nPoints - 2 );

		// Chamada de desenho - drawcall
		// CONTORNO - GL_LINE_LOOP
		// PONTOS - GL_POINTS
		glUniform4f(colorLoc, 0.5f, 0.5f, 1.0f, 1.0f); //enviando cor para variável uniform inputColor
		glDrawArrays(GL_LINE_LOOP, 3, nPoints);
		
		glUniform4f(colorLoc, 1.0f, 0.0f, 0.5f, 1.0f); //enviando cor para variável uniform inputColor
		glDrawArrays(GL_POINTS, 3, nPoints );
