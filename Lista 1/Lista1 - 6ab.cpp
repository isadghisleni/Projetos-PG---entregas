	 ...
	 * Última atualização em 25 / 03 / 2022
	 *
	 */


	 //	 ATENÇÃO -->> este código contém o exercício 6.a) e .b)
	 //           Altere as linhas 100 e 101 para cada questão.
...
int main()
{
	...
	GLuint shaderID = setupShader();
				...
				//>> mude aqui o código para o exercício 6.a e 6.b:
		
	//int nPoints = 8;  //>>  deixar legível para 6.a
	//int nPoints = 5;  //>>  deixar legível para 6.b

	
	
	GLuint VAO = generateCircle(0.5, nPoints); //raio e nPoints
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4f(colorLoc, 0.8f, 0.2f, 0.8f, 1.0f); //enviando cor para variável uniform inputColor
		glBindVertexArray(VAO);
		glDrawArrays(GL_TRIANGLE_FAN, 1, nPoints );
		...
		glDrawArrays(GL_POINTS, 0, nPoints + 2);
